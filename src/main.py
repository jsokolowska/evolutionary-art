...
if __name__ == "__main__":
    ...
    fitness4, index4 = random_aesthetic()
    fitness5, index5 = random_aesthetic()
    fitness6, index6 = random_aesthetic()
    ...
    aesthetic_fitness_list = [AestheticFitness(fitness1, p, "c1"),
                              ...
                              AestheticFitness(fitness4, p, "c1"),
                              AestheticFitness(fitness5, p, "c2"),
                              AestheticFitness(fitness6, p, "c3"),
                              ImitationAesthetic("../target/starry_night.jpg")]
    weights = [1/6, 1/6, 1/6,1/6, 1/6, 1/6, 2]
